  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (chartHistogramContacts1) {
        chartHistogramContacts1.data.datasets[0].data = data.map(function (o) {
          return o.actual;
        });
        chartHistogramContacts1.data.datasets[1].data = data.map(function (o) {
          return o.total;
        });
            ...
            datasets: [
              {
                ...
                label: "Resueltos",
                backgroundColor: color("#2C9E8E").alpha(0.2).rgbString(),
                borderColor: "#2C9E8E",
                weight: 3,
                borderWidth: 1,
                datalabels: {
              ...
              },
              {
                ...
                label: "Total",
                backgroundColor: color("#004D96").alpha(0.2).rgbString(),
                borderColor: "#004D96",
                weight: 3,
                borderWidth: 1,
                datalabels: {
