function updateChartincidentsSeverity() {
  setInterval(chartincidentsSeverity, 2000);
}
...
function chartincidentsSeverity() {
  $.ajax({
    method: "POST",
    url: "/api/dash/incident/byseveritylevel",
    cache: false,
    success: function (data) {
      ...
      if (chartincidentsSeverity1) {
        chartincidentsSeverity1.data.datasets[0].data = data.map(function (o) {
          return o.actual;
        });
        chartincidentsSeverity1.data.datasets[1].data = data.map(function (o) {
          return o.total;
        });
            ...
            datasets: [
              {
                ...
                label: "Resueltos",
                backgroundColor: color("#FF4C97").alpha(0.2).rgbString(),
                borderColor: "#FF4C97",
                weight: 3,
                borderWidth: 1,
                datalabels: {
              ...
              },
              {
                ...
                label: "Total",
                backgroundColor: color("#F9B941").alpha(0.2).rgbString(),
                borderColor: "#F9B941",
                weight: 3,
                borderWidth: 1,
                datalabels: {
