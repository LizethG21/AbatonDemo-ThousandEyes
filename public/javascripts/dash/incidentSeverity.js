...
var chartIncidentSeverity1;
function chartIncidentSeverity() {
  $.ajax({
    method: "POST",
    url: "/api/dash/incident/byseverity",
    cache: false,
    success: function (data) {
      var dataset = [];
      var colors = ["#3e95cd", "#8e5ea2", "#3cba9f"];
      var bordercolors = ["#3e95cd", "#8e5ea2", "#3cba9f"];
      var ctx = document.getElementById("chartIncidentSeverity");
      var context = ctx.getContext("2d");
      if (chartIncidentSeverity1) {
        chartIncidentSeverity1.data.datasets[0].data = data.map(function (o) {
          return o.count;
        });
        chartIncidentSeverity1.update();
        var html = "";
        for (let o in data) {
          html +=
        ...
        $("#dataIncidentSeverity").html(html);
      } else {
        ...
        chartIncidentSeverity1 = new Chart(ctx, {
          type: "doughnut",
          data: {
